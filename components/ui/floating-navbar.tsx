    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/80 px-2 py-1.5 shadow-lg shadow-black/10 backdrop-blur-md dark:border-white/10 dark:bg-black/50">
          ...
          <div className="flex items-center gap-1">
            {navItems.map((navItem, idx: number) => (
              <>
                ...
                <div className="h-5 last:hidden w-px bg-neutral-200 dark:bg-white/10" />
              </>
            ))}
          </div>
          ...
          {/* CTA Button     <button className="relative rounded-full bg-neutral-900 px-4 py-2 text-sm font-medium text-white transition-all hover:bg-neutral-800 hover:shadow-lg hover:shadow-neutral-900/20 dark:bg-white dark:text-black dark:hover:bg-neutral-100 dark:hover:shadow-white/20">
            <span>Login</span>
          </button> */}
        </div>
      </motion.div>
